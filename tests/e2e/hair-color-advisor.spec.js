...
const SVC_URL = "https://appadaycreator.com/hair-color-advisor/";
const SVC_NAME = "ヘアカラー診断";

test.describe("ヘアカラー診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("hair-color-advisor");
